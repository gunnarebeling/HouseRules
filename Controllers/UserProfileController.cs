...
public class UserProfileController : ControllerBase
{
    ...
    public IActionResult getUserDetails(string id) 
    {
        ...
        UserProfileDTO profile = _dbContext.UserProfiles.Include(up => up.IdentityUser).Select(up => new UserProfileDTO
        {
            Id = up.Id,
            FirstName = up.FirstName,
            LastName = up.LastName,
            ...
            Chores = up.Chores.Select(c => new ChoreDTO 
            {
                Id = c.Id,
                Name = c.Name,
            ...
            ChoreCompletions =  up.ChoreCompletions.Select(cc => new ChoreCompletionDTO
            {
                Id = cc.Id,
                ChoreId = cc.ChoreId,
                Chore = new SimpleChoreDTO {Name = cc.Chore.Name},
